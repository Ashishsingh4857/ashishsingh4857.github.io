					...
					{!showMore ? (
						<>
							<p className="mt-6 text-center text-sm text-gray-300 leading-relaxed px-4">
								I'm Alex Chen, a full-stack
								developer building performant
								web apps with a focus on clean
						...
						<>
							...
							<div className="mt-6 flex gap-3">
								<button className="flex-1 py-3 rounded-xl bg-[#E8C86A] text-black font-semibold text-sm hover:bg-yellow-300 transition">
									Download Resume
								</button>
								<button className="flex-1 py-3 rounded-xl border border-yellow-400/40 text-yellow-200 text-sm hover:bg-yellow-400/10 transition">
									Contact Me
								</button>
							</div>
